...
aptitude install -y -r omxplayer arduino screen wiringPi libpam-systemd libasound2-dev python-serial telnet mosquitto mosquitto-clients libmosquitto-dev libmosquittopp-dev qt5-default libpcre++-dev libboost-dev libdbus-1-dev 
